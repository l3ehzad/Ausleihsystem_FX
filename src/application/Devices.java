...
public class Devices {
    ...
    public Devices(String deviceName, String labelName, int inventID) {
    ...
    public static boolean checkDeviceAvailByDevID(int deviceID) throws SQLException{
        int availablity = 0;
        PreparedStatement statement = DatabaseConnection.conn.prepareStatement("SELECT available FROM device WHERE deviceID = "+ deviceID + ";");
        ResultSet result = statement.executeQuery();
        while (result.next()){
    ...
    public static void listOfAllDevices () throws SQLException {
        ...
        PreparedStatement statement = DatabaseConnection.conn.prepareStatement("SELECT * FROM device;");
    ...
    public static void postDevice (Devices device) throws Exception{
        PreparedStatement posted = DatabaseConnection.conn.prepareStatement("INSERT INTO device (deviceName, labelName, fk_inventID) VALUES ('"+device.getDeviceName()+"', '"+device.getLabelName()+"','"+device.getInventID()+"')");
